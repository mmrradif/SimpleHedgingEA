//+------------------------------------------------------------------+
//|                                        SimpleHedgingEA_v1_Safe.mq5|
//|                                Copyright 2026, Antigravity AI    |
//|                                             https://www.mql5.com |
//| Description: Version 1 (Safe) - Lot 0.01 to 0.10, TP $5, DD $500 |
//+------------------------------------------------------------------+
#property copyright "Copyright 2026, Antigravity AI"
#property link      "https://www.mql5.com"
#property version   "1.00"
#property description "Safe Version 1: Lot 0.01-0.10, Target Profit $5.00, Max DD $500.00"
...
int OnInit()
{
   ...
   PrintFormat("[INIT] Safe EA v1 Initialized. Lot 0.01-0.10, Target: $%.2f, Max DD: $%.2f", 
...
void OnTick()
{
   ...
   // 4. GUARANTEED PROFIT EXIT ($5.00 TARGET)
...
void SetupProgressivePendingGrid()
{
   ...
   for(int i = 1; i <= stepCount; i++)
   {
      ...
      m_trade.BuyStop(lot, price, _Symbol, 0, 0, ORDER_TIME_GTC, 0, "BuyStop Safe v1");
   ...
   for(int i = 1; i <= stepCount; i++)
   {
      ...
      m_trade.SellStop(lot, price, _Symbol, 0, 0, ORDER_TIME_GTC, 0, "SellStop Safe v1");
