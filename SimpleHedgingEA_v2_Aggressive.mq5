//+------------------------------------------------------------------+
//|                                  SimpleHedgingEA_v2_Aggressive.mq5|
//|                                Copyright 2026, Antigravity AI    |
//|                                             https://www.mql5.com |
//| Description: Version 2 (Aggressive) - Lot 0.10-0.20, TP $50, DD $1000|
//+------------------------------------------------------------------+
#property copyright "Copyright 2026, Antigravity AI"
#property link      "https://www.mql5.com"
#property version   "2.00"
#property description "Aggressive Version 2: Lot 0.10-0.20, Target Profit $50.00, Max DD $1000.00"
...
input double   InpMaxLotLimit         = 0.20;     // Max Lot Limit (0.20) - 11 Orders
...
input double   InpTargetProfitUSD     = 50.00;    // Target Net Profit per Basket ($50.00 Close All)
...
input ulong    InpMagicNumber         = 888222;   // Magic Number
...
int OnInit()
{
   ...
   PrintFormat("[INIT] Aggressive EA v2 Initialized. Lot 0.10-0.20, Target: $%.2f, Max DD: $%.2f", 
...
void OnTick()
{
   // 1. Strict Emergency Drawdown Check
   ...
   // 4. GUARANTEED PROFIT EXIT ($50.00 TARGET)
...
void SetupProgressivePendingGrid()
{
   ...
   for(int i = 1; i <= stepCount; i++)
   {
      ...
      m_trade.BuyStop(lot, price, _Symbol, 0, 0, ORDER_TIME_GTC, 0, "BuyStop Aggressive v2");
   ...
   for(int i = 1; i <= stepCount; i++)
   {
      ...
      m_trade.SellStop(lot, price, _Symbol, 0, 0, ORDER_TIME_GTC, 0, "SellStop Aggressive v2");
                     ...
                     double &totalBuyLot, double &totalSellLot)
{
   ...
   for(int i = PositionsTotal() - 1; i >= 0; i--)
   {
      ...
      if(ticket > 0 && PositionGetString(POSITION_SYMBOL) == _Symbol && PositionGetInteger(POSITION_MAGIC) == InpMagicNumber)
      {
         ...
         if(type == POSITION_TYPE_BUY) { buyCount++; totalBuyLot += vol; }
         else if(type == POSITION_TYPE_SELL) { sellCount++; totalSellLot += vol; }
      }
   }
